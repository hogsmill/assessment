...
APPS=(
  ...
  'agile-maturity-and,agileMaturityAndServer,agileMaturityAndTeams,agileMaturityAndQuestions,agileMaturityAndAssessments,3121,Agile Maturity,Agile Maturity'
